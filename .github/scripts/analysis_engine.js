...
async function generateGeminiReport(client, searchData) {
    const prompt = `
        당신은 대한민국 최고의 마케팅 전략가입니다. 아래 업체에 대한 온라인 현황 데이터와 정보를 바탕으로 전문적인 상권 분석 리포트를 작성해주세요.
        ...
        다음 구조로 JSON 형식으로만 응답해주세요 (HTML 태그 <b>, <br> 활용):
        {
            "stp": "...",
            "aida": "...",
            "swot": "...",
            ...
            "toolkit": {
                "hooks": ["후킹 멘트 1", "후킹 멘트 2", "후킹 멘트 3"],
                "hashtags": "#태그1 #태그2",
                "action_plan": ["월요일: ...", "수요일: ...", "금요일: ..."]
            }
        }
    `;
